                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                        ...
                                        <tr>
                                            <td style="width:250px;">
                                                <img height="auto" src="{{ url('frontend/images/logo.svg') }}"
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                            ...
                            <tr>
                                <td align="center"
                                    ...
                                    <div
                                        style="font-family:Playfair Display, serif;font-size:30px;font-weight:bold;line-height:1;text-align:center;color:#071c4d;">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <div
                                                    style="font-family:Assistant, Halvetica, Arial, sans-serif;font-size:18px;line-height:28px;text-align:left;color:#071c4d;">
                                                    Hi, {{ $data->user->name }}<br/><br/> Tiket digital kamu sudah
                                                    berhasil dicetak.<br/>
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                                       style="color:#071c4d;font-family:Assistant, sans-serif;font-size:18px;line-height:28px;table-layout:auto;width:100%;border:none;">
                                                    <tr>
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                                       style="color:#071c4d;font-family:Assistant, sans-serif;font-size:18px;line-height:28px;table-layout:auto;width:100%;border:none;">
                                                    <tr>
                                                        <td colspan="3">Travel Detail's</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td align="center" bgcolor="#ff9e53" role="presentation"
                                                            ...
                                                            <a href="{{ url('checkout/'. $data->id) }}"
                                                               style="display:inline-block;background:#ff9e53;color:#ffffff;font-family:Assistant, sans-serif;font-size:18px;font-weight:bold;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:8px;">
                                                                Check Detail </a>
                                                        </td>
                                                    </tr>
                                                </table>
    ...
    <div style="background:#ffffff;background-color:#ffffff;margin:0px auto;max-width:600px;">
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
            ...
            <tr>
                            ...
                            <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                        ...
                                        <tr>
                                            <td style="width: 50px">
                                                <img src="{{ url('frontend/images/ic_cs.png') }}" width="50px"/>
                                            </td>
                                            <td style="
                font-size: 16px;
                line-height: 20px;
                padding-left: 15px;
                color: #071c4d;
                font-family: Assistant, Halvetica, Arial, sans-serif;
              "> support@ramtravel.id<br/> 081215478273
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                ...
                <td style="direction:ltr;font-size:0px;padding:20px 0;padding-bottom:30px;padding-top:3px;text-align:center;">
                    ...
                    <div class="mj-column-per-100 mj-outlook-group-fix"
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                            ...
                            <tr>
                                <td align="center"
                                    style="font-size:0px;padding:10px 25px;padding-top:25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                    <div
                                        style="font-family:Assistant, halvetica, Arial, sans-serif;font-size:18px;line-height:1;text-align:center;color:#888b93;">
                                        2021 Ramtravel Copyright All Rights Reserved
                                    </div>
                                </td>
                            </tr>
                            </tbody>
